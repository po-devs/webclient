...
18:"{ Ends wild battles. In trainer battles, replaces opponent with a random non-active Pokémon in opponent's party; fails if opponent's party has no non-active Pokémon. Ignores the effects of Protect and Detect. Fails either way if Ingrain is in effect for opponent. Priority level -6.}",
...
20:"{Multi-turn attack. If this attack is successful, the effect begins. Effect lasts for [four or five] rounds, including the current round. During effect, opponent cannot switch or flee, and at the end of every round except the last, opponent loses 1/16 of total HP. Effect ends when user is replaced or opponent is replaced or uses Rapid Spin. The effect is not reset when this or another multi-turn attack is used against opponent during effect.}",
23:"May cause opponent to flinch. (30%) Power is doubled, and this move will not miss if Minimize is in effect for opponent.",
24:"Strikes twice.",
...
46:"{ Ends wild battles. In trainer battles, replaces opponent with a random non-active Pokémon in opponent's party; fails if opponent's party has no non-active Pokémon. Ignores the effects of Protect and Detect. Fails either way if Ingrain is in effect for opponent. Priority level -6.}",
...
81:"Decreases opponent's Speed by 2 stages.",
...
87:"May paralyze opponent. (30%) During Rain Dance, this attack hits without fail. Otherwise, during Sunny Day, this attack's accuracy is 50. Can hit opponent even if it is using Fly, Bounce, or Sky Drop.",
...
92:"Badly poisons opponent. If used by a Poison-type Pokémon, this move will never fail, and will hit during the invulnerability turn of Bounce, Dig, Dive, Fly, Phantom Force, Shadow Force, and Sky Drop.",
...
203:"Until the end of the round, if an attack by non-users would reduce user's HP to less than 1, its damage is changed so that it reduces user's HP to 1 instead. This attack fails if it occurred last this round. A variable, X, starts at 0, and resets to 0 if the last move called for the user is not Protect, Detect, Endure, Quick Guard, Wide Guard, King's Shield, or Spiky Shield as user uses this attack or if this attack fails, and increases by 1 (up to 3) each time this attack is successful. This attack has a 50% chance of failing if X is 1, a 75% chance if X is 2, and an 87.5% chance if X is 3. Priority level 4.",
...
229:"If this attack is successful, effects of multi-turn attacks and Leech Seed end for user, and effect of Spikes, Stealth Rock, Sticky Web, and Toxic Spikes ends for user's side.",
230:"Decreases opponent's evasiveness by 2 stages.",
...
267:"This move uses different attacks depending on the location. On grass, and while Grassy Terrain is active, uses Energy Ball. In caves or on rocky ground, uses Power Gem. On snow and ice, uses Blizzard. On sand and other outdoor ground, uses Mud Bomb. On water, uses Hydro Pump. In buildings, including Wi-Fi battles, uses Tri Attack. While Electric Terrain is active, uses Thunderbolt. While Misty Terrain is active, uses Moonblast.",
...
282:"If this attack is successful, opponent drops its held item for the rest of the battle even if it has zero HP. If the opponent loses an item this way, the power of this move is increased by 50%. Remains effective even if opponent is replaced. (That item is not consumed.)",
...
290:"This move has a 30% chance to apply a secondary effect. On grass, may put opponent to sleep. In caves or on rocky ground, may cause opponent to flinch. On snow and ice, may freeze opponent. On sand and other outdoor ground, may decrease opponent's Accuracy by 1 stage. On water, may decrease opponent's Attack by 1 stage. In buildings, including Wi-Fi battles, may paralyze opponent.",
...
363:"This attack's type and power depend on the Berry the user is holding. Unless this attack misses, even if this attack becomes ineffective due to type immunities, the item is consumed, but the user doesn't gain its effect. Fails if user has Klutz, if user could not use its held item, or if user's item isn't a Berry (item is not consumed in those cases).",
...
407:"May cause opponent to flinch. (20%) Power is doubled, and this move will not miss if Minimize is in effect for opponent.",
...
432:"Decreases opponent's evasiveness by 1 stage. Even if opponent's evasiveness cannot be decreased, ends the effects of Reflect, Light Screen, Safeguard, Mist, Spikes, Toxic Spikes, Stealth Rock, and Sticky Web on the opponent's side, and of Spikes, Toxic Spikes, Stealth Rock, and Sticky Web on the user's side, and ends fog.",
...
448:"Confuses opponent if used by Chatot.",
...
479:"If this attack is successful, it ends the effects of Bounce, Fly, Magnet Rise and Telekinesis for the opponent, and if the opponent has the Ability Levitate or is a Flying type, removes opponent's immunity to Ground-type attacks and Arena Trap. Effect ends when opponent is replaced. Can hit opponent even if it is using Fly, Bounce, or Sky Drop.",
...
510:"If this attack is successful, and the opponent is holding a Berry or a Gem, that item becomes unusable for the duration of the battle.",
...
537:"May cause opponent to flinch. (30%) Power is doubled, and this move will not miss if Minimize is in effect for opponent.",
...
542:"May confuse opponent. (30%) During Rain Dance, this attack hits without fail. Otherwise, during Sunny Day, this attack's accuracy is 50. Can hit opponent even if it is using Fly, Bounce or Sky Drop.",
...
549:"Decreases opponent's Speed by 1 stage.",
...
560:"Decreases opponent's Attack by 1 stage. Priority level 1.",
562:"Protects the user's party from all Other category moves for one turn. Fails if user strikes last this round. Priority level 3.",
564:"If this attack is successful, user gains 3/4 of HP lost by opponent due to this attack.",
566:"The type effectiveness for this attack is the result of the multiplication of Fighting type effectiveness and Flying type effectiveness. Power is doubled, and this move will not miss if Minimize is in effect for opponent.",
567:"If the opponent isn't part Grass type, adds Grass typing to the opponent.",
568:"Deals super effective damage against Water type. May freeze opponent. (10%)",
569:"Two-turn move. Increases user's Special Attack, Special Defense and Speed by 2 stages.",
571:"{Multi-turn attack. If this attack is successful, the effect begins. Effect lasts for [four or five] rounds, including the current round. During effect, opponent cannot switch or flee, and at the end of every round except the last, opponent loses 1/16 of total HP. Effect ends when user is replaced or opponent is replaced or uses Rapid Spin. The effect is not reset when this or another multi-turn attack is used against opponent during effect.}",
572:"May decrease opponent's Special Attack by 1 stage. (30%)",
573:"Decreases opponent's Special Attack by 1 stage.",
574:"Decreases opponent's Attack and Special Attack by 1 stage.",
575:"Paralyzes opponent.",
576:"If this attack is successful, user gains 3/4 of HP lost by opponent due to this attack.",
577:"If this attack is successful, user gains half of HP lost by opponent due to this attack.",
578:"Two-turn attack, user is invulnerable during the first turn. Power is doubled, and this move will not miss if Minimize is in effect for opponent. Ignores effect of Protect or Detect.",
579:"May decrease opponent's Attack by 1 stage. (10%)",
580:"Decreases opponent's Attack by 1 stage.",
581:"If the opponent isn't part Ghost type, adds Ghost typing to the opponent.",
582:"Multi-hit attack. Attacks two to five times in a row. 37.5% for 2 or 3 times; 12.5% for 4 or 5 times. Priority level 1.",
583:"Increases the Special Defense of Pokémon on the user's side by 1 stage.",
584:"This attack cannot be selected unless the user has eaten a Berry.",
585:"Decreases opponent's Special Attack by 1 stage.",
586:"Cannot be evaded.",
587:"Decreases opponent's Special Attack by 2 stages.",
588:"Terrain move. For 5 turns, including the current round, grounded Pokémon cannot fall asleep, and have the power of their Electric-type moves increased by 50%.",
589:"If opponent has not moved yet, changes the type of opponent's next move to Electric.",
590:"Prevents any Pokémon from switching out during the turn it was used and the following one.",
591:"If this attack knocks out opponent, increases the user's Attack by 2 stages.",
592:"Increases Defense of all Grass-type Pokémon in battle by 1 stage.",
593:"Terrain move. For 5 turns, including the current round, grounded Pokémon restore 1/16 of their HP at the end of each turn, and have the power of their Grass-type moves increased by 50%.",
594:"For the current turn, all Normal-type moves used have their type changed to Electric. Priority level 1.",
595:"User avoids offensive attacks used this round by non-users. This attack fails if user strikes last this round. If opponent uses a contact move, decreases its Attack by 2 stages. A variable, X, starts at 0, and resets to 0 if the last move called for the user is not Protect, Detect, Endure, Quick Guard, Wide Guard, King's Shield, or Spiky Shield as user uses this attack or if this attack fails, and increases by 1 (up to 3) each time this attack is successful. This attack has a 50% chance of failing if X is 1, a 75% chance if X is 2, and an 87.5% chance if X is 3. Priority level 4.",
597:"Increases Defense and Special Defense of Pokémon on the user's side with the Plus or Minus Ability by 1 stage.",
598:"Protects user's party from offensive moves. Fails if user strikes last this round. Fails unless it's the user's first turn since user last became active.",
599:"Terrain move. For 5 turns, including the current round, grounded Pokémon cannot have their status altered, and take half damage from Dragon-type moves.",
600:"Decreases opponent's Attack and Special Attack by 1 stage. After this move is used, if this move is successful, if user has at least 1 HP, and if user's party has at least one non-active Pokémon and the opposing Pokemon's party has at least one unfainted Pokémon that isn't an egg, this attack causes the user to switch even if it cannot switch. (The new Pokémon becomes active immediately.)",
601:"For the current turn, if opponent uses a Fire type move, the move fails and opponent loses 1/4 its max HP. Priority level 1.",
602:"Increases user's Attack by 1 stage.",
603:"Increases Attack and Special Attack of all grounded Grass-type Pokémon on the field by 1 stage.",
604:"User avoids certain attacks used this round by non-users. This attack fails if user strikes last this round. If opponent uses a contact move, it loses 1/8 of its max HP. A variable, X, starts at 0, and resets to 0 if the last move called for the user is not Protect, Detect, Endure, Quick Guard, Wide Guard, King's Shield, or Spiky Shield as user uses this attack or if this attack fails, and increases by 1 (up to 3) each time this attack is successful. This attack has a 50% chance of failing if X is 1, a 75% chance if X is 2, and an 87.5% chance if X is 3. Priority level 4.",
605:"During effect, whenever an opposing Pokémon becomes active, that Pokémon, unless it's a Flying type or has Levitate, has its Speed decreased by 1 stage.",
606:"Reverts all stat of opponent's stat changes. Positive changes becomes negative, and vice versa.",
607:"Fails unless opponent is Poisoned. Decreases opponent's Attack, Special Attack and Speed by 1 stage.",
};
...
18:"Immediately ends wild battles. Forces trainers to switch Pokémon.",
...
239:"Has a $effect_chance% chance to make the target flinch.",
...
235:"Heals the user by half its max HP.  Affected by weather.",
236:"Heals the user by half its max HP.  Affected by weather.",
239:"Has chance to make the target flinch.",
262:"Lowers the target's Attack and Special Attack by two levels.  User faints.",
};
